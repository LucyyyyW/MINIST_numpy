...
def get_args():
    ...
    ### params for network
    parser.add_argument('--iterations_num', default=1000, type=int)
    ...
    parser.add_argument('--record_per', default=100, type=int)
    parser.add_argument('--ck_per', default=500, type=int)
...
class build_net():
    ...
    def resume(self, checkpoint):
        ...
        assert self.hid_cn == checkpoint['hid_cn']
...
if __name__ == '__main__':
    ...
    if args.state == 'train':
        ...
        draw_loss(index_list,loss_test_list,args.train_output, 'test_loss')
        draw_loss(index_list,acc_test_list,args.acc_outpath, 'test_acc')
